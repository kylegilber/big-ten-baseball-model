...
# Load 2023 player data
load("~/Github/big-ten-baseball-model/data23.RData")
```
...
levels(NEB_B23$PlayResult)[levels(NEB_B23$PlayResult) == "SIngle"] <- "Single"
levels(NEB_P23$PlayResult)[levels(NEB_P23$PlayResult) == "SIngle"] <- "Single"
```
